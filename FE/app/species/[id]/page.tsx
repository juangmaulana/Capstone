      ...
      try {
        ...
        if (json.success && json.data && json.data.length > 0) {
          ...
          setPlant({
            ...
            botanicalDescriptionEn: p.botanicalDescriptionEn || p.botanical_description_en || p.botanicalDescription || p.botanical_description || p.description || "",
            botanicalDescriptionId: p.botanicalDescriptionId || p.botanical_description_id || p.botanicalDescription || p.botanical_description || p.description || "",
            ecologicalInformation: p.ecologicalInformation || p.ecological_information || p.ecology || "",
            ecologicalInformationEn: p.ecologicalInformationEn || p.ecological_information_en || p.ecologicalInformation || p.ecological_information || p.ecology || "",
            ecologicalInformationId: p.ecologicalInformationId || p.ecological_information_id || p.ecologicalInformation || p.ecological_information || p.ecology || "",
