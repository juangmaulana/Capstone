...
const MOCK_LOGS: LogEntry[] = [
  { id: 1, timestamp: "2026-04-15 09:32:14", level: "success", source: "Annotation", message: "Annotated image IMG_20260115_001.jpg — species: Acacia nilotica", user: "Siti Nurhaliza" },
  ...
  { id: 5, timestamp: "2026-04-15 08:40:11", level: "success", source: "Annotation", message: "Annotated image IMG_20260205_003.jpg — species: Ageratum conyzoides (corrected from Chromolaena odorata)", user: "Siti Nurhaliza" },
  ...
  { id: 8, timestamp: "2026-04-14 23:00:00", level: "success", source: "Annotation", message: "Annotated image IMG_20260222_005.jpg — species: Mikania micrantha", user: "Rudi Hermawan" },
          ...
          <div className="flex items-center gap-2">
            ...
            {(["all", "info", "warning", "error", "success"] as const).map((level) => (
              <button
                ...
                className={`rounded-full px-3 py-1 text-xs font-medium capitalize transition-colors ${filter === level
